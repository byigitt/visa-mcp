...
server.tool(
  "list_visas",
  {
    country_code: z.string().optional().describe("Filter by country code (e.g., 'tur', 'gbr')"),
    mission_code: z.string().optional().describe("Filter by mission code (e.g., 'bgr', 'fin')"),
...
server.tool(
    ...
    { country_code: z.string().describe("The country code to filter by (e.g., 'tur', 'gbr')") },
...
server.tool(
    ...
    { mission_code: z.string().describe("The mission code to filter by (e.g., 'bgr', 'fin')") },
